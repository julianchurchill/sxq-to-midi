...
def note_length_table(ppqn):
    return {
        ...
        (64, 3, 52): (ppqn * 111) // 16,# whole tied half tied dotted 8th tied dotted 32nd
        (64, 7, 14):   (ppqn * 15) // 8,# dotted quarter tied dotted 16th
        ...
        (64, 11, 51):(ppqn * 109) // 16,# whole tied half tied dotted 8th tied 64th
        (64, 15, 13):  (ppqn * 7) // 4, # quarter tied dotted eighth (7x16ths)
        (64, 15, 28):  (ppqn * 15) // 4,# half tied quarter tied dotted eighth
        (64, 15, 43): (ppqn * 92) // 16,# whole tied quarter tied dotted 8th
        (64, 15, 58):(ppqn * 124) // 16,# whole tied dotted half tied dotted 8th
        ...
        (64, 19, 50):(ppqn * 107) // 16,# whole tied half tied 8th tied dotted 32nd
        ...
        (64, 27, 49):(ppqn * 105) // 16,# whole tied half tied 8th tied 64th
        (64, 31, 11):  (ppqn * 3) // 2, # dotted quarter
        (64, 31, 26):  (ppqn * 7) // 2, # half tied dotted quarter
        (64, 31, 41): (ppqn * 88) // 16,# whole tied dotted quarter
        (64, 31, 56):(ppqn * 120) // 16,# whole tied dotted half tied 8th
        ...
        (64, 35, 48):(ppqn * 103) // 16,# whole tied half tied 16th tied dotted 32nd
        # expecting (64, 35, 23)
        ...
        (64, 43, 47):(ppqn * 101) // 16,# whole tied half tied 16th tied 64th
        # expecting (64, 46, 23)
        (64, 47, 9):   (ppqn * 5) // 4, # quarter tied sixteenth (5x16ths)
        (64, 47, 24):  (ppqn * 13) // 4,# half tied quarter tied sixteenth
        (64, 47, 39): (ppqn * 84) // 16,# whole tied quarter tied 16th
        (64, 47, 54):(ppqn * 116) // 16,# whole tied dotted half tied 16th
        ...
        (64, 63, 37): (ppqn * 80) // 16,# whole tied quarter
        (64, 63, 52):(ppqn * 112) // 16,# whole tied dotted half
        ...
        (64, 67, 59):(ppqn * 127) // 16,# whole tied dotted half tied dotted 8th tied dotted 32nd
        # expecting (64, 70, 23)
        ...
        (64, 75, 58):(ppqn * 125) // 16,# whole tied dotted half tied dotted 8th tied 64th
        (64, 79, 5):  (ppqn * 3) // 4,  # dotted eighth
        (64, 79, 20): (ppqn * 11) // 4, # half tied dotted eighth (11x16ths)
        (64, 79, 35): (ppqn * 76) // 16,# whole tied dotted 8th
        (64, 79, 50):(ppqn * 108) // 16,# whole tied half tied dotted 8th
        ...
        (64, 83, 57):(ppqn * 123) // 16,# whole tied dotted half tied 8th tied dotted 32nd
        # expecting (64, 84, 11)
        ...
        (64, 91, 56):(ppqn * 121) // 16,# whole tied dotted half tied 8th tied 64th
        (64, 95, 3):   ppqn // 2,       # eighth
        (64, 95, 18):  (ppqn * 5) // 2, # half tied eighth (10x16ths)
        (64, 95, 33): (ppqn * 72) // 16,# whole tied 8th
        (64, 95, 48):(ppqn * 104) // 16,# whole tied half tied 8th
        ...
        (64, 107, 54):(ppqn * 117) // 16,# whole tied dotted half tied 16th tied 64th
        (64, 111, 1):  ppqn // 4,       # sixteenth
        (64, 111, 16): (ppqn * 9) // 4, # half tied sixteenth (9x16ths)
        (64, 111, 31):(ppqn * 68) // 16,# whole tied 16th
        (64, 111, 46):(ppqn * 100) // 16,# whole tied half tied 16th
        ...
        (64, 115, 53):(ppqn * 115) // 16,# whole tied dotted half tied dotted 32nd
